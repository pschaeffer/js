...
class HDLmWebpageImprover {
  ...
  static buildWebUiElement() {
    ...
    let suggestionElement = HDLmReactFive.buildSuggestionAreaWLabel('Suggestion (optional)', 'Enter a suggestion for the revenue improver', 'suggestionInputWpiWIV1', suggestionKeyDown, HDLmWebpageImprover.suggestionCurrentValue, helpTextWpiWIV1['suggestion']);
