...
class HDLmReactSeven {
  ...
  static buildSpinnerElement() {
    let spinnerStyle = { display: 'inline-block', width: '40px', height: '40px', border: '6px solid #f3f3f3', borderTop: '6px solid #3498db', borderRadius: '50%', animation: 'hdlm-wsi-v1-spin 1s linear infinite' };
